...
<jsp:include page="admin_header.jsp" />
	...
	<br>
		 ...
		 <center>
  			<font size="5" color="#696969"><b> 판매자 정보 수정 </b>
 			 </font>
 		 </center>
		...
		<form action="updateSeller2" method="post" >
		...
		<div align=center style="padding: 0% 5% 0% 5%">
			<input type="button" value="판매자 회원 삭제"
                ...
                margin-top:30px;"
                 ...
                 onclick="location.href='deleteSeller2?seller_num=${ seller.seller_num }' "
				>
