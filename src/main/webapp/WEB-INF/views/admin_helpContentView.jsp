...
<body onload="replyData()">
	...
	<br>
		...
		<br>
			<c:choose>
				<c:when test="${sessionScope.managerSession.manager_code == 0415}">
			
			<input type="button" value="수정" onclick="location.href='admin_helpModifyForm?help_num=${personalData.help_num}'">
			<input type="button" value="삭제" onclick="location.href='admin_deleteHelp?help_num=${personalData.help_num}'">
			<input type="button" onClick="location.href='admin_help'" value="목록 보기">
				...
				<br><br>
						<!-- 관리자 로그인시에만 답변 보이게 함 -->
			<input type="button" value="답변하기" onclick="slideClick()"
