...
<jsp:include page="seller_header.jsp" />
    ...
    <div class="footer-copyright">
        <p class="footer-company"><font size="3"><b>
        	${sessionScope.sellerSession.seller_id} 판매자님 , &nbsp;&nbsp;&nbsp; 전체 상품 목록입니다.
        </b></font></p>
    </div>
		...
		<br>
		 ...
		 <center>
  			<font size="5" color="#696969"><b> 상품 DB </b>
 			 </font>
 		 </center>
	...
	<th> <font size="4" color="#57AD5F"><b>상품 번호</font></b>
</th>
	<th><font size="4" color="#57AD5F"><b> 이미지</font></b>
</th>
	<th> <font size="4" color="#57AD5F"><b>이름</font></b>
</th>
	<th> <font size="4" color="#57AD5F"><b>가격</font></b>
</th>
	<th> <font size="4" color="#57AD5F"><b>추천수</font></b>
</th>
	<th> <font size="4" color="#57AD5F"><b>구매수</font></b>
</th>
	<th> <font size="4" color="#57AD5F"><b>재고량</font></b>
</th>

	</tr>
	<tbody >
		<c:forEach var="imsi" items="${itemlist}" >
		...
		<tr>
			...
			<td>
			<img src="images/${imsi.item_image}" width=200px height=200px>
			</td>
			<td>
				${imsi.item_name}
			</td>
