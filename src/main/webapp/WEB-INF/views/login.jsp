...
<jsp:include page="header.jsp" />
    ...
    <td>
   	...
   	<tr>
   	<td>
    <a href="signup" ><font size="3" color="#696969"><b>회원가입</b></font></a>
    <td>
    </tr>
...
<br>
	...
	<td>
	<input id="id" type="text" name="buyer_id" placeholder="아이디를 입력해주세요"
	...
	<td>
	<input id="password" type="password" name="buyer_password" placeholder="비밀번호를 입력해주세요"
