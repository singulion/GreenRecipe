...
<br>
		 ...
		 <center>
  			<font size="5" color="#696969"><b> 판매자 권한 설정 </b>
 			 </font>
 		 </center>
			<br>
		...
		<br>
			...
			<div align=center >
			 <table border="0" style=" padding: 0% 15% 0% 15%; border-spacing: 5px 5px; border-collapse: separate;"  >
			
			<tr>
				<td><font size="3" color="#696969"><b>아이디</b></font>
				</td>
			...
			<td><font size="3" color="#696969"><b>이메일</b></font>
			</td>							
			
			<td>${ seller.seller_email }"
		...
		<tr>
			<td><font size="3" color="#696969"><b>스토어명</b></font>
			</td>
		
			<td>${ seller.seller_storeName }
		...
		<tr>
			<td><font size="3" color="#696969"><b>스토어 전화번호</b></font>
			</td>
			...
			<tr>
					<td><font size="3" color="#696969"><b>스토어 주소</b></font>
		
		</td>
				<td>${ seller.seller_storeAddr }</td>
			...
			<tr>
					<td> <font size="4" color="#696969"><b>현재 권한</b></font>
		
				</td>
		
		
				<td><c:if test="${seller.seller_access == 0}">
					<font size="4" color="red">판매 관리 미승인</font> </c:if>

					<c:if test="${seller.seller_access == 1}">
					<font size="4" color=" #1e48e0">판매 관리 승인</font></c:if>
					...
					<tr>    <form action="updateAccess" method="post" >
					
					<td > <font size="4" color="#57AD5F"><b>권한 설정</b></font>
					</td>
					
					<td>     
					
				<input type="radio" name="seller_access" 
				value="0" required>
				<font size="4" color="red"><b>&nbsp;권한 미부여</b> </font>&nbsp;&nbsp;<br>
				
				<input type="radio" name="seller_access" 
				value="1"  required>
				<font size="4" color=" #1e48e0"><b>&nbsp;권한 부여</b> </font>
				</td>
			...
			<tr> 
				...
				<input type="submit" value="판매자 권한 설정"
