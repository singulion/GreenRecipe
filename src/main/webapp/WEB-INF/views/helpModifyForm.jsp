...
<body>
	...
	<br>
		...
		<form method="post" action="updateHelp2" style="text-align: left">
			<input type="hidden" name="help_num" value="${help.help_num}">
		
			<font size="3" color="#696969"><b>제목</b></font><br><br>
			 <input type="text" size="50" name="help_title" value="${help.help_title}"> <br><br>
			 
			 <font size="3" color="#696969"><b>내용</b></font><br><br>
			<textarea name="help_content" rows="15" cols="50">${help.help_content}</textarea> <br><br>
