...
<br>
	...
	<div id="helpWrite" style="width: 400px; margin: 0 auto;">
		<h1>상품 문의</h1>
		<form method="post" action="${contextPath}/inquiry/inquiryWriteSave" enctype="multipart/form-data" style="text-align: left">
			<input type="text" size="50" name="title" placeholder="상품 이름" disabled="disabled"> <br><br>
			<textarea name="content" rows="15" cols="50" placeholder="상품 문의 내용을 입력해주세요." ></textarea> <br><br>
		</form>
	</div>
